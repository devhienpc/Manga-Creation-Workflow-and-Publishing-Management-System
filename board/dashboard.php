        ...
        <div style="margin-top: 20px; display: flex; flex-direction: column; gap: 15px;">
            <div>
                ...
                <div style="height: 6px; border-radius: 3px; background: rgba(255,255,255,0.05);">
                    <div style="height: 100%; border-radius: 3px; background: var(--red); width: 85%;"></div>
                </div>
            </div>
            <div>
                <div style="display: flex; justify-content: space-between; font-size: 0.9rem; margin-bottom: 5px;">
                ...
                <div style="height: 6px; border-radius: 3px; background: rgba(255,255,255,0.05);">
                    <div style="height: 100%; border-radius: 3px; background: var(--red); width: 50%;"></div>
                </div>
            </div>
        </div>
    </div>
